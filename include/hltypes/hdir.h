...
namespace hltypes
{
	...
	public:
		...
		static HL_INLINE bool getWin32FullDirectoryPermissions() { return win32FullDirectoryPermissions; }
		/// @brief Sets flag for creating directories with full access permissions on Win32 (Vista and later).
		/// @param[in] value New value.
		static HL_INLINE void setWin32FullDirectoryPermissions(bool value) { win32FullDirectoryPermissions = value; }
